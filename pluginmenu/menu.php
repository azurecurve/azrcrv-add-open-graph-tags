 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_aogt')){
	function azrcrv_create_plugin_menu_aogt(){
		azrcrv_create_plugin_menu_table_aogt();
		azrcrv_populate_plugin_menu_table_aogt();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_aogt')){
	function azrcrv_populate_plugin_menu_table_aogt(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_aogt')){
	function azrcrv_create_plugin_menu_table_aogt(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
