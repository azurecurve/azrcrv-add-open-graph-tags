...
if (!function_exists('azrcrv_plugin_menu')){
	function azrcrv_plugin_menu(){
		...
		$plugin_array = array(
			array(
				'plugin_link' => 'azrcrv-add-open-graph/azrcrv-add-open-graph.php',
				'admin_URL'=> 'admin.php?page=azrcrv-aog',
				'dev_URL'=> 'https://development.azurecurve.co.uk/classicpress-plugins/add-open-graph/',
				'text' => 'Add Open graph'
			),
			array(
