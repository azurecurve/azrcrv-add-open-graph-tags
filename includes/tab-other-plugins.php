...
$tab_plugins_label = esc_html__( 'Other Plugins', 'azrcrv-aogt' );
$tab_plugins       = '
<table class="form-table azrcrv-settings">
	...
	<tr>
		...
		<th scope="row" colspan=2 class="azrcrv-settings-section-heading">
				...
				<h2 class="azrcrv-settings-section-heading">' . esc_html__( 'Integrated Plugins', 'azrcrv-aogt' ) . '</h2>
...
// check if floating featured image plugin is active.
if ( check_is_plugin_active( 'azrcrv-add-twitter-cards/azrcrv-add-twitter-cards.php' ) ) {
	$plugin_atc = '<a href="admin.php?page=azrcrv-atc" class="azrcrv-plugin-index">Add Twitter Cards</a>';
} else {
	$plugin_atc = '<a href="https://development.azurecurve.co.uk/classicpress-plugins/add-twitter-cards/" class="azrcrv-plugin-index">Add Twitter Cards</a>';
}
	...
	<tr>
		...
		<td scope="row" colspan=2>
			...
			<label for="additional-plugins">
				' . sprintf( esc_html__( '%1$s integrates with the following plugins from %2$s:', 'azrcrv-aogt' ), '<strong>' . PLUGIN_NAME . '</strong>', DEVELOPER_URL ) . '
			</label>
	...
	<tr>
		...
		<th scope="row" colspan=2 class="azrcrv-settings-section-heading">
				...
				<h2 class="azrcrv-settings-section-heading">' . esc_html__( 'Complimentary Plugins', 'azrcrv-aogt' ) . '</h2>
	...
	<tr>
		...
		<td scope="row" colspan=2>
			...
			<label for="complimentary-plugins">
				' . sprintf( esc_html__( 'The below plugin from %1$s compliments %2$s:', 'azrcrv-aogt' ), DEVELOPER_URL, '<strong>' . PLUGIN_NAME . '</strong>' ) . '
			</label>
			<ul class="azrcrv-plugin-index">
				<li>
					' .
	...
	<tr>
		...
		<th scope="row" colspan=2 class="azrcrv-settings-section-heading">
				...
				<h2 class="azrcrv-settings-section-heading">' . esc_html__( 'Available Plugins', 'azrcrv-aogt' ) . '</h2>
	...
	<tr>
		...
		<td scope="row" colspan=2>
			...
			<p>' .
				sprintf( esc_html__( 'Other plugins available from %s, which you are not using, are:', 'azrcrv-aogt' ), DEVELOPER_URL )
			. '</p>
