...
<form method="post" action="admin-post.php">
	...
	<input type="submit" name="btn_save" value="<?php esc_html_e( 'Save Settings', 'azrcrv-aogt' ); ?>" class="button-primary"/>
</form>
...
<div class='azrcrv-donate'>
	<?php
		printf( esc_html__( 'Support %s', 'azrcrv-aogt' ), esc_html( DEVELOPER_NAME ) );
	?>
	...
	<span>
		<?php
		esc_html_e( 'You can help support the development of our free plugins by donating a small amount of money.', 'azrcrv-aogt' );
		?>
	</span>
</div>
