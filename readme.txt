...
Download link:	https://github.com/azurecurve/azrcrv-add-open-graph-tags/releases/download/v1.1.0/azrcrv-add-open-graph-tags.zip
...
### [Version 1.1.0](https://github.com/azurecurve/azrcrv-add-open-graph-tags/tree/v1.1.0)
 * Add integration with Update Manager for automatic updates.
 * Fix issue with display of azurecurve menu.
 * Change settings page heading.
 * Add load_plugin_textdomain to handle translations. 

### [Version 1.0.1](https://github.com/azurecurve/azrcrv-add-open-graph-tags/tree/v1.0.1)
 * Add integration with Update Manager for automatic updates.
 * Fix issue with display of azurecurve menu.
 * Change settings page heading.

### [Version 1.0.0](https://github.com/azurecurve/azrcrv-add-open-graph-tags/tree/v1.0.0)
 * Initial release.
